        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CropName = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: false),
                    ...
                    ModalPrice = table.Column<decimal>(type: "numeric(12,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AreaInAcres = table.Column<double>(type: "numeric(10,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlantDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityAvailable = table.Column<decimal>(type: "numeric(12,2)", nullable: false),
                    Unit = table.Column<string>(type: "text", nullable: false),
                    ReorderThreshold = table.Column<decimal>(type: "numeric(12,2)", nullable: false),
                    Notes = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DailyWage = table.Column<decimal>(type: "numeric(10,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpenseTime = table.Column<TimeSpan>(type: "interval", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Unit = table.Column<string>(type: "text", nullable: false),
                    PricePerUnit = table.Column<decimal>(type: "numeric(12,2)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 7, 17, 19, 28, 29, 259, DateTimeKind.Utc).AddTicks(3727), false, true, "Seeds", null, null },
                    { 2, new DateTime(2026, 7, 17, 19, 28, 29, 259, DateTimeKind.Utc).AddTicks(3732), false, true, "Fertilizer", null, null },
                    { 3, new DateTime(2026, 7, 17, 19, 28, 29, 259, DateTimeKind.Utc).AddTicks(3734), false, true, "Pesticides", null, null },
                    { 4, new DateTime(2026, 7, 17, 19, 28, 29, 259, DateTimeKind.Utc).AddTicks(3734), false, true, "Labor", null, null },
                    { 5, new DateTime(2026, 7, 17, 19, 28, 29, 259, DateTimeKind.Utc).AddTicks(3735), false, true, "Fuel", null, null },
                    { 6, new DateTime(2026, 7, 17, 19, 28, 29, 259, DateTimeKind.Utc).AddTicks(3736), false, true, "Irrigation", null, null },
                    { 7, new DateTime(2026, 7, 17, 19, 28, 29, 259, DateTimeKind.Utc).AddTicks(3737), false, true, "Electricity", null, null },
                    { 8, new DateTime(2026, 7, 17, 19, 28, 29, 259, DateTimeKind.Utc).AddTicks(3737), false, true, "Machinery", null, null },
                    { 9, new DateTime(2026, 7, 17, 19, 28, 29, 259, DateTimeKind.Utc).AddTicks(3738), false, true, "Equipment Repair", null, null },
                    { 10, new DateTime(2026, 7, 17, 19, 28, 29, 259, DateTimeKind.Utc).AddTicks(3739), false, true, "Packaging", null, null },
                    { 11, new DateTime(2026, 7, 17, 19, 28, 29, 259, DateTimeKind.Utc).AddTicks(3740), false, true, "Transport", null, null },
                    { 12, new DateTime(2026, 7, 17, 19, 28, 29, 259, DateTimeKind.Utc).AddTicks(3740), false, true, "Miscellaneous", null, null }
                });
